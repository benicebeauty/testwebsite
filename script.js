/* ==========================================================================
   BE NICE CLINIC — LUXURY CORE JAVASCRIPT ENGINE (BLOCK 1/2)
   ========================================================================== */
document.addEventListener("DOMContentLoaded", function() {
    ...
    function initLuxuryTitleAnimation() {
        ...
        if (!mainTitle) return; // Ha nincs az oldalon (pl. aloldalak), biztonságosan átugorjuk
    ...
    function initLuxuryHeroButton() {
        ...
        if (!desktopBtn) return; // Ha nincs az oldalon, biztonságosan átugorjuk
    ...
    // ==========================================================================
    // 6. ASZIMMETRIKUS ANIMÁCIÓS MOTOR — BIZTONSÁGOS ELLENŐRZÉSSEL
    // ==========================================================================
        ...
        const scrollObserver = new IntersectionObserver(function(entries, observer) {
            ...
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    ...
                    if (el.classList.contains('clean-luxury-card')) {
    ...
    function initLuxuryCustomDropdown() {
        ...
        if (!dropdown) return; // Ha nincs az oldalon, csendben átugorjuk
    ...
    function initUniversalPriceTabs() {
        ...
        if (!tabButtons.length || !tabPanels.length) return; // Ha nincs fül az oldalon, átugorjuk
